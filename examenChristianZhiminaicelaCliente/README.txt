...
a persistence unit "examenChristianZhiminaicelaClientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenChristianZhiminaicelaCliente\pom.xml":
...
artifact ("examenChristianZhiminaicelaCliente.war") is already built. You can build
